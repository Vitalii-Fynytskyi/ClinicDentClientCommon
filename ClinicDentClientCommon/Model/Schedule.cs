...
namespace ClinicDentClientCommon.Model
{
    ...
    public class Schedule
    {
        ...
        public Schedule(string id, string startDateTime, string endDateTime, string comment, string patientId, string doctorId, string patientName, string cabinetId, string cabinetName, string state, string priceSum, string payedSum, string messagerStateNumber, string doctorsId, string expensesSum)
        {
            ...
            char[] splitChars = { '|' };
            string[] priceSumSplit = priceSum.Split(splitChars, StringSplitOptions.RemoveEmptyEntries);
            string[] paidSumSplit = payedSum.Split(splitChars, StringSplitOptions.RemoveEmptyEntries);
            string[] doctorIdsSplit = doctorsId.Split(splitChars, StringSplitOptions.RemoveEmptyEntries);
            string[] expensesSumSplit = expensesSum.Split(splitChars, StringSplitOptions.RemoveEmptyEntries);
